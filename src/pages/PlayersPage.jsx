...
import { getPlayerSnapshot } from '../utils/stats';
import {
  applyAliases,
  normalizeText,
  pickBestMatch,
...
export default function PlayersPage({
  ...
  function handleSubmit(event) {
    ...
    if (editingId) {
      onUpdatePlayer?.(editingId, playerData);
      setFeedback('Jogador atualizado com sucesso.');
    } else {
      const createdPlayer = onAddPlayer?.(playerData) || null;
